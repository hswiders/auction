	...
	<div class="row">
		...
		<div class="col-sm-9">
			<div class="right-side">
				...
				<p>Change your currency settings</p>		
					...
					<div class="col-sm-8">
						...
						<!-- Text input-->
							 <div class="form-group">
							  ...
							  <div class="">
							  <input type="hidden" name="first_name" value="<?= $this->auth['first_name'] ?>" class="form-control"> 
 								<input type="hidden" name="last_name" value="<?= $this->auth['last_name'] ?>" class="form-control"> 
							  <select class="form-control" name="currency"> 
								<?php $curr = $this->common_model->GetAllData('currency' , '' , 'id' , 'desc'); ?>
								<?php foreach ($curr as $key => $value): ?>
									<option <?= ($value['title'] == $this->auth['currency']) ? 'selected' : '' ?> value="<?= $value['title'] ?>"><?= $value['title'] ?></option>
								<?php endforeach ?>
