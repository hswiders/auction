...
<div class="account-page">
	<div class="row">
		...
		<?php $seller_info = $this->common_model->GetSingleData('seller_billing_info' , ['user_id' => $this->auth_id]); ?>
		<div class="col-sm-9">
			<div class="right-side">
              ...
              <div class="form-group">
                ...
                <div class="">
                  <input type="number" placeholder="Card Number" name="card_number" value="<?= ($seller_info) ? $seller_info['card_number'] : '' ?>" class="form-control" required> 
              ...
              <div class="form-group">  
                <div class="row">
                    <div class="col-sm-3">
                      <input type="text" placeholder="Expire" name="card_expire" value="<?= ($seller_info) ? $seller_info['card_expire'] : '' ?>" class="form-control" required> 
                    </div>
                    <div class="col-sm-3">
                      <input type="number" placeholder="CVV" name="card_cvv" class="form-control" value="<?= ($seller_info) ? $seller_info['card_cvv'] : '' ?>" required> 
                    </div>
                </div>
              </div>
              <br>
...
<script>
  ...
  function do_update (e) 
  {
    e.preventDefault();
      $('.alert-danger').remove();
      $.ajax({
      url: '<?= base_url() ?>/User/do_update_seller',
      type: 'POST',
      cache:false,
      contentType: false,
      processData: false,
