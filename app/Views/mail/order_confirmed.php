                                ...
                                <table border="0" width="640" cellspacing="0" cellpadding="0" align="center" style="border-collapse:collapse">
                                  <tbody>
                                    <tr>
                                        ...
                                        <tbody>
                                        <tr>
                                        <td align="center" width="65" style="border-collapse:collapse;padding:15px 0 0px 30px">
                                        <a href="<?= base_url() ?>" rel="noreferrer noopener" target="_blank"><img alt="<?= Project ?>" width="100" height="auto" style="display:block;border:none;font-family:ProximaNova,Helvetica,Arial,sans-serif;color:#ffffff;text-transform:none;font-size:15px;letter-spacing:1px;line-height:25px;max-width:100px" src="<?= base_url() ?>/assets/img/logo.png" class="CToWUd" data-bit="iit"></a></td>
                                        <td align="center" style="border-collapse:collapse;padding:15px 0px 0 30px;border:none;font-family:ProximaNova,Helvetica,Arial,sans-serif;font-size:12px;color:#ffffff;text-decoration:none;text-transform:uppercase;text-align:right;font-weight:400;min-width:150px;display:inline-block;line-height:15px;height:auto">
                                        </td>
                                        <td align="center" style="border-collapse:collapse;padding:15px 30px 0 0px;border:none;font-family:ProximaNova,Helvetica,Arial,sans-serif;font-size:20px;color:#ffffff;text-decoration:none;text-transform:uppercase;text-align:right;width:300px;display:inline-block;font-weight:500;line-height:30px;height:auto">
                                        <span id="m_5030694996870727866ydpda4fb4b3yiv9015868292x_estimated" style="font-weight:400;display:none;line-height:15px;height:auto"></td>
                                        </tr>
                                        </tbody>
                                        </table>
                                        </td>
                                    ...
                                    <tr>
                                      <td align="center" style="border-collapse:collapse;padding:0;line-height:0;font-size:0">
                                        <img alt="" style="display:block;border:none;font-family:ProximaNova,Helvetica,Arial,sans-serif;text-transform:none;font-size:15px;letter-spacing:1px;line-height:25px;max-width:800px;text-align:left;width:640px" src="<?= base_url() ?>/assets/img/01.png" class="CToWUd a6T" data-bit="iit" tabindex="0">
                                          ...
                                          <tbody>
                                            <tr>
                                              <td align="center" width="640" style="font-family:ProximaNova,Helvetica,Arial,sans-serif;font-size:30px;color:#000005;text-decoration:none;text-align:center;line-height:36px;font-weight:600">
                                                <a href="#" style="color:#000000;text-decoration:none" rel="noreferrer noopener" target="_blank">Order Confirmation</a>
                                              </td>
                                            </tr>
                                          </tbody>
                                        </table>
                                          ...
                                          <tbody>
                                            <tr>
                                              <td align="center" width="640" style="font-family:ProximaNova,Helvetica,Arial,sans-serif;font-size:18px;color:#000005;text-decoration:none;text-align:left;line-height:24px;font-weight:400">
                                                Congrats! Your latest <?= Project ?> purchase is on the way. </td>
                                            </tr>
                                          </tbody>
                                        </table>
                                      </td>
                                                        ...
                                                        <td align="center" bgcolor="#ffffff">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <a href="<?= get_product_url($product);?>" rel="noreferrer noopener" target="_blank" >
                                                                    <img alt="<?= $product['title'] ?>" src="<?= base_url($image['image']) ?>" style="width:260px;max-width:800px" class="CToWUd" data-bit="iit">
                                                                </a>
                                                                </td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <table border="0" cellspacing="0" cellpadding="0" align="left">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td align="right" style="font-family:ProximaNova,Helvetica,Arial,sans-serif;font-size:12px;color:#000000;text-decoration:none;text-align:right;line-height:16px;font-weight:400"> <?= $this->currency ?><?= $grand_total ?></td>
                                                                            </tr>
                                                                            </tbody>
                                                                        </table>
                                                                        <table border="0" cellspacing="0" cellpadding="0" align="left">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td align="right" style="font-family:ProximaNova,Helvetica,Arial,sans-serif;font-size:12px;color:#000000;text-decoration:none;text-align:right;line-height:16px;font-weight:400"> <?= $this->currency ?><?= $trans_fee ?></td>
                                                                            </tr>
                                                                            </tbody>
                                                                        </table>
                                                                        <table border="0" cellspacing="0" cellpadding="0" align="left">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td align="right" style="font-family:ProximaNova,Helvetica,Arial,sans-serif;font-size:12px;color:#000000;text-decoration:none;text-align:right;line-height:16px;font-weight:400"> <?= $shipping_fee ?> </td>
                                                                            </tr>
                                                                            </tbody>
                                                                        </table>
                                                                        <table border="0" cellspacing="0" cellpadding="0" align="left">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <span style="font-weight:500"><?= $this->currency ?><?= $grand_total + $admin_fee ?></span>
                                                                                </td>
                                                                            </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <table border="0" cellspacing="0" cellpadding="0">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <a href="<?= base_url() ?>/buy-orders?type=completed" style="font-size:18px;font-family:ProximaNova,Helvetica,Arial,sans-serif;color:#ffffff;text-decoration:none;border-radius:2px;border:0;display:inline-block;line-height:35px;padding:0 15px;font-weight:500" rel="noreferrer noopener" target="_blank">View Order</a>
                                                                                </td>
                                                                            </tr>
                                                                            </tbody>
                                                                        </table>
                                          ...
                                          <tbody>
                                            <tr>
                                              <td align="center" style="border-collapse:collapse">
                                                <a href="<?= base_url() ?>" rel="noreferrer noopener" target="_blank">
