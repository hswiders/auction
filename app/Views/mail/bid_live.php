...
$payment_fee = convert_currency($order['payment_fee'] ,  $this->currency , 'HKD');                                                     
...
<tbody> 
<tr>
<td id="m_-1044079087543220284ydp93773b1ayiv7473363770letterHeader" style="font-family:Arial,Helvetica Neue,Helvetica,sans-serif;font-size:55px;color:#d4d1c7;text-decoration:none;text-align:left;line-height:55px;font-weight:600" align="right">Your Bid Is Live!</td>
</tr>
<tr>
...
<tr>
<td id="m_-1044079087543220284ydp93773b1ayiv7473363770price" style="font-family:Arial,Helvetica Neue,Helvetica,sans-serif;font-size:85px;color:#3e4c96;text-decoration:none;text-align:left;line-height:75px;font-weight:600;padding:0px 40px 40px 0" align="right" width="280"><?= $this->currency ?><?= $grand_total ?></td>
</tr>
</tbody>
</table>
</td>
...
<tbody>
<tr>
<td id="m_-1044079087543220284ydp93773b1ayiv7473363770notop" style="font-family:Arial,Helvetica Neue,Helvetica,sans-serif;font-size:18px;color:#000005;text-decoration:none;text-align:left;line-height:24px;font-weight:400" align="center" width="100%">Thank you for placing a Bid on our marketplace. We'll send you updates on other Bids and lower Asks for this item should you ever want to adjust. Remember, the quickest way to get your hands on this is to just to <a href="<?= get_product_url($product);?>">Buy Now</a>.</td>
</tr>
</tbody>
</table>
</td>
...
<tr>
<td style="font-family:Arial,Helvetica Neue,Helvetica,sans-serif;font-size:13px;color:#000005;text-decoration:none;text-align:left;line-height:16px;font-weight:600;padding:15px 0 0 15px" width="280">Your Bid Expiration:&nbsp; <?= date('d F Y',strtotime($order['expire_date'])); ?></td>
</tr>
...
<tbody>
<tr>
<td style="font-family:Arial,Helvetica Neue,Helvetica,sans-serif;font-size:13px;color:#000000;text-decoration:none;text-align:left;line-height:16px;font-weight:600;min-width:200px" width="200">Your Bid:</td>
...
<td style="font-family:Arial,Helvetica Neue,Helvetica,sans-serif;font-size:13px;color:#000000;text-decoration:none;text-align:right;line-height:16px;font-weight:600" align="right"><?= $this->currency ?><?= number_format($trans_fee) ?></td>
</tr>
</tbody>
</table>
<!-- <table border="0" cellspacing="0" cellpadding="0" align="left">
...
<td style="font-family:Arial,Helvetica Neue,Helvetica,sans-serif;font-size:13px;color:#000000;text-decoration:none;text-align:right;line-height:16px;font-weight:600" align="right"><?= $this->currency ?><?= number_format($payment_fee) ?></td>
</tr>
</tbody>
</table> -->
...
<td style="font-family:Arial,Helvetica Neue,Helvetica,sans-serif;font-size:13px;color:#000000;text-decoration:none;text-align:right;line-height:16px;font-weight:600" align="right"><?= $shipping_fee ?></td>
</tr>
</tbody>
</table>
