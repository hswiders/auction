...
<div class="admin-dash">
  <div class="container">
		...
		<?php $shipping_info = $this->common_model->GetSingleData('user_shipping_info' , ['user_id' => $edit['id']]); ?>
		<div class="col-sm-9">
			<div class="right-side">
				<div class="rightjhead">
					<h1>Shipping Info</h1>
				</div>
				<p>Change your Shipping Info</p>		
...
<script>
  ...
  function do_update (e) 
  {
    e.preventDefault();
      $('.alert-danger').remove();
      $.ajax({
      url: '<?= base_url() ?>/Admin/Users/do_update_shipping',
      type: 'POST',
      cache:false,
      contentType: false,
      processData: false,
