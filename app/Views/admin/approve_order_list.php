          ...
          <tbody>
            ...
            $x = 1;
              if ($approve_order_list) {
                foreach ($approve_order_list as $key => $value) {
                    ?>
              <tr>
                <td><?= $x; ?></td>
                <td>Order ID :<?= $value['order_uniqueid'] ?></td>
                            ...
                            ?></td> 
                            <td><?= date('d F Y h:i A' , strtotime($value['approval_date'])) ?></td>
                            <td style="white-space:nowrap;"><?php 
                           ...
                           <td>
                             <button class="btn btn-success btn-sm" onclick="accept_product(<?php echo $value['id']; ?>,3,<?php echo $userdata['id']; ?>)" id="btn_load<?= $value['id']; ?>" >Mark as Complete</button>
...
<div class="modal" id="myrejectModal<?= $value['id']; ?>">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <!-- Modal body -->
        <form id="reject_product" method="post" action="#" onsubmit="return reject_product()" >
            <div class="col-md-12 py-3">
                ...
                <div class="mt-3 text-center">
                    <button type="submit" id="add_btn"  class="btn btn-success">Reject</button>
                </div>
