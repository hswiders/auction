        ...
        <div class="row">
            ...
            <div class="col-md-9">
        		<div class="table-part">
                    <div>
        			    <h4 class="d-flex justify-content-between">Banner management: <button class="btn btn-info" data-toggle="modal" data-target="#myModal" id="add_btns">Add</button></h4>
...
function editBanner(el , id) {
    $('.alert-danger').remove();
    $.ajax({
        url: '<?= base_url() ?>/Admin/Banner/editBanner',
        type: 'POST',
        cache:false,
        contentType: false,
        processData: false,
