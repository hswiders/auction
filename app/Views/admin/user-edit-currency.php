					...
					<div class="col-sm-8">
						...
						<!-- Text input-->
							 <div class="form-group">
							  ...
							  <div class="">
							  <input type="hidden" name="first_name" value="<?= $edit['first_name'] ?>" class="form-control"> 
 								<input type="hidden" name="last_name" value="<?= $edit['last_name'] ?>" class="form-control"> 
							  ...
							  <select class="form-control" name="currency"> 
								...
								<?php foreach ($curr as $key => $value): ?>
									<option <?= ($value['title'] == $edit['currency']) ? 'selected' : '' ?> value="<?= $value['title'] ?>"><?= $value['title'] ?></option>
								<?php endforeach ?>
